...
def step(planner:HumanoidMotionPlanner):
    constraint_r=planner.generate_constraints(obj_name="cube", obj_id=1, action="move", hand_name="right",relative_obj_name="cube",relative_obj_id=0,relative_p=np.array([0,0,0.06]))
