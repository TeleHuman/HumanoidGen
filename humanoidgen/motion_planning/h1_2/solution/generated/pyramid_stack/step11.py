...
def step(planner:HumanoidMotionPlanner):
    constraint_r=planner.generate_constraints(obj_name="cube", obj_id=2, action="move", hand_name="right",relative_obj_name="cube",relative_obj_id=1,relative_p=np.array([0,0.03,0.06]))
